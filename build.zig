...
pub fn build(b: *std.Build) void {
    ...
    const zbench_opts = .{ .target = target, .optimize = optimize };
    const zbench = b.dependency("zbench", zbench_opts).module("zbench");
    ...
    exe_mod.addImport("xxhash", lib_mod);
